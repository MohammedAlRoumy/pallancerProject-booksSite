<header class="app-header"><a class="app-header__logo" style="font-family:'Lato' , sans-serif" href="{{route('dashboard.welcome')}}">زاد</a>
    ...
    <!-- User Menu-->
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li><a class="dropdown-item" href="{{ route('welcome') }}"><i class="fa fa-home fa-lg"></i>
                        {{ __('الموقع') }}
